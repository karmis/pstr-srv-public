...
export class FillerService {
    ...
    public example = async () => {
        ...
        // crawler
        const crawler = await this.createCrawler({name: 'fb-puppet-crawler'});
    ...
    protected getFilesPath(): string {
        const cwd: string = process.cwd();
        return path.relative(cwd, './data/auto/');
    }
